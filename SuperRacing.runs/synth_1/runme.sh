...
HD_PWD='D:/vivado_project/SuperRacing/SuperRacing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SuperRacing.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SuperRacing.tcl
