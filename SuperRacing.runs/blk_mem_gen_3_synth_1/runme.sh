...
HD_PWD='D:/vivado_project/SuperRacing/SuperRacing.runs/blk_mem_gen_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_3.tcl
