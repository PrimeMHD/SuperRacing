...
HD_PWD='D:/vivado_project/SuperRacing/SuperRacing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SuperRacing.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SuperRacing.tcl -notrace
