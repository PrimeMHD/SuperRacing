...
HD_PWD='D:/vivado_project/SuperRacing/SuperRacing.runs/blk_mem_gen_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_5.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_5.tcl
